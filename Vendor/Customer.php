                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search12" class="input-text header-searchbar" placeholder="Search for Customer name or Email" list="Customer">&nbsp;&nbsp;
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My Customers<?php echo (" ($list11->num_rows)"); /*echo $selecttype." Customers (".$list11->num_rows.")";*/ ?></p>
                    </td>
